...
describe("EUR serial-format validation", () => {
  ...
  it.each([1, 2, 500, 1000])(
    "rejects unsupported denomination %i",
    (denomination) => {
  ...
  it.each([
    ...
    {
      serial: "PA812416175",
      reason: "too short; Europa serials require 2 letters and 10 digits",
    },
    {
      serial: "PA81241617590",
      reason: "too long; Europa serials require exactly 12 characters",
    },
    { serial: "P8124161759", reason: "missing the second leading letter" },
    {
      serial: "PA812416175X",
      reason: "contains a non-digit in the numeric suffix",
    },
    {
      serial: "IA8124161759",
      reason: "I is not assigned a first-letter control value",
    },
    {
      serial: "OA8124161759",
      reason: "O is not assigned a first-letter control value",
    },
    {
      serial: "QA8124161759",
      reason: "Q is not assigned a first-letter control value",
    },
    {
      serial: "PA8124161758",
      reason: "checksum digit sequence does not match P's control value",
    },
...
describe("JPY serial-format validation", () => {
  ...
  it.each([
    ...
    "accepts valid Series-F $denomination yen serial $serial",
    ({ denomination, serial }) => {
      expect(jpy.validSerial(serial, denomination)).toBe(true);
    },
  );

  it.each(["SA815862T", "A069406A", "Z815962A", "AA495803A"])(
    "accepts valid Series-D 2000 yen serial %s",
    (serial) => {
  ...
  it.each([1, 5, 10, 100, 500, 3000, 20000])(
    "rejects unsupported denomination %i",
    (denomination) => {
  ...
  it.each([
    { denomination: 1000, serial: "", reason: "empty input is not a serial" },
    {
      denomination: 1000,
      serial: "AA161373AHH",
      reason: "too long for a Series-F serial",
    },
    {
      denomination: 1000,
      serial: "A161373AH",
      reason: "missing the second leading letter",
    },
    {
      denomination: 1000,
      serial: "AA16137AH",
      reason: "numeric portion is too short",
    },
    {
      denomination: 1000,
      serial: "AA161373A",
      reason: "missing the second trailing letter",
    },
    {
      denomination: 1000,
      serial: "IA161373AH",
      reason: "I is not used in JPY serial letters",
    },
    {
      denomination: 1000,
      serial: "OA161373AH",
      reason: "O is not used in JPY serial letters",
    },
    {
      denomination: 1000,
      serial: "AA000000AH",
      reason: "000000 is below the valid serial range",
    },
    {
      denomination: 1000,
      serial: "AA900001AH",
      reason: "900001 is above the valid serial range",
    },
    {
      denomination: 1000,
      serial: "SA815862T",
      reason: "old Series-D serial format is only accepted for 2000 yen notes",
    },
    {
      denomination: 2000,
      serial: "AA161373AH",
      reason:
        "Series-F serial format is not accepted for Series-D 2000 yen notes",
    },
    {
      denomination: 2000,
      serial: "SA000000T",
    ...
    "rejects $serial for $denomination yen because $reason",
    ({ denomination, serial }) => {
...
describe("USD serial-format validation", () => {
  ...
  it.each([
    ...
    "accepts observed online $denomination dollar serial $serial",
    ({ denomination, serial }) => {
  ...
  it.each([
    ...
    },
    {
      denomination: 1,
      serial: "A234567890A",
      reason: "numeric portion is too long",
    },
    {
      denomination: 1,
      serial: "M23456789A",
      reason: "first letter must identify an A-L Federal Reserve Bank",
    },
    {
      denomination: 1,
      serial: "A23456789O",
      reason: "O is not used as a suffix letter",
    },
    {
      denomination: 1,
      serial: "A23456789Z",
      reason: "Z is reserved for test printings",
    },
    {
      denomination: 1,
      serial: "BA23456789A",
      reason: "$1 and $2 notes do not use the redesigned two-letter prefix",
    },
    {
      denomination: 5,
      serial: "BM23456789A",
      reason:
        "second redesigned prefix letter must identify an A-L Federal Reserve Bank",
    },
    {
      denomination: 5,
      serial: "BA00000000A",
      reason: "00000000 is below the valid serial range",
    },
    {
      denomination: 5,
      serial: "IG00000000T",
      reason: "official specimen display serial uses an invalid all-zero range",
    },
    {
      denomination: 5,
      serial: "BA23456789O",
    ...
    "rejects $serial for $denomination dollars because $reason",
    ({ denomination, serial }) => {
